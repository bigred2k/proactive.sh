...
echo "Searching for binary files within /var/www/, /var/tmp, and /tmp"
echo "These are typically malicious files:"
find /var/www/ /var/tmp/ /tmp/ -type f -exec file -i '{}' \; | grep 'x-executable; charset=binary'
...
echo "Searching for files and directories owned apache:apache within /var/www/, /var/tmp, and /tmp . Please be patient"
...
find /var/www/ /var/tmp /tmp -user apache -group apache
